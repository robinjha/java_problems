...
public class ComparatorTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Using comparator -- Last name as the key");
		Arrays.sort(emp, Employee.EmployeeNameComparator);
		count = 0;
		for(Employee e: emp){
			System.out.println("Employees " + ++count + ":" + e.getFirstName() +" "+ e.getLastName() +"," + e.getEmpId());
		}
